...
describe("supply draw pool formal route", () => {
  it("uses /dashboard/cards as the formal draw-pool route and keeps the legacy page as a redirect", () => {
    ...
    expect(formalPage).toContain('<BoardApp activeTab="supply" supplyPanel="drawPool" />');
