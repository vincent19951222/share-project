...
describe("supply dashboard formal route", () => {
  it("uses /dashboard/status as the formal status route and keeps the legacy page as a redirect", () => {
    ...
    expect(formalPage).toContain('<BoardApp activeTab="supply" supplyPanel="dashboard" />');
