...
- `主线未实现能力`：继续补齐团队动态、文档中心、周报、企业微信、战报复盘等团队内容和基础设施
...
- 继续打磨 P3 已完成基础能力：赛季结算、管理员赛季管理、看板 / Profile 经济语义
- 补齐战报中心赛季复盘：
  赛季收入、冲刺贡献、成员贡献排行、赛季进度解释和阶段性总结
- 打磨中文文案、移动端体验、表单交互和异常提示
- 这条线是后续暴击道具接入赛季贡献前的基础稳定性要求
